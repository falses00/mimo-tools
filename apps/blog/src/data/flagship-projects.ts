...
export const flagshipProjects: FlagshipProject[] = [
  ...
  },
  {
    ...
    path: '/projects/repopilot',
    featured: true,
    status: 'available',
    techStack: ['TypeScript', 'GitHub API', 'Fastify'],
    capabilities: ['热榜发现', '安全审查', '部署计划', '本地 Runner', '风险评估'],
    highlights: ['GitHub 热榜', '危险脚本检测', '部署计划生成', '安全确认机制'],
    isFrontendOnly: false,
    hasBackend: true,
    hasRAG: false,
  },
  ...
  },
  {
    ...
    path: '/projects/opspilot',
    featured: true,
    status: 'available',
    techStack: ['TypeScript', 'Fastify', 'Chart.js'],
    capabilities: ['API 健康检查', '日志分析', '事故复盘', '服务监控', '报告导出'],
    highlights: ['实时监控', '异常检测', '本地优先', 'API Mode', '历史记录'],
    isFrontendOnly: false,
    hasBackend: true,
    hasRAG: false,
  },
